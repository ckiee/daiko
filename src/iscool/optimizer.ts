import { ExamLessonCell, EventLessonCell, FreeLessonCell, LessonCell, LocationChangeLessonCell, StdLessonCell } from "./scraper";
...
export class IscoolOptimizer {
    processSlot(slot: LessonCell[]) {
        ...
        const exams = <ExamLessonCell[]>slot.filter(c => c.type == "exam");
